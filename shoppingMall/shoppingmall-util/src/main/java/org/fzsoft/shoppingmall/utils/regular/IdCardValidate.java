package org.fzsoft.shoppingmall.utils.regular;
...
public class IdCardValidate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String idcard18 = "511321198908168790";//
        // 15位身份证
        System.out.println(validate(idcard15));
        // 18位身份证
        System.out.println(validate(idcard18));
        // 15位身份证转18位身份证
