...
public class StringUtil extends StringUtils {
     ...
     * @return
     */
    public static Date parseCardToDate(String card) {
    	...
    	if(card.length()==18){
    		//截取年月日
    		 year=Integer.valueOf(card.substring(6, card.length()-8));
    		 month=Integer.valueOf(card.substring(10, card.length()-6));
    		 day=Integer.valueOf(card.substring(12, card.length()-4));
    	}else if (card.length()==15){
    		//截取年月日
	   		 year=Integer.valueOf("19"+card.substring(6, card.length()-7));
	   		 month=Integer.valueOf(card.substring(8, card.length()-5));
	   		 day=Integer.valueOf(card.substring(10, card.length()-3));
    	}
